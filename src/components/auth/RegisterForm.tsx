...
import { UserPlus, KeyRound, AtSign, Eye, EyeOff, User } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-400 mt-2">let's get this party started 🎉</p>
      </div>
        ...
        <div className="space-y-2">
          <div className="relative">
            ...
            <input
              ...
              placeholder="drop ur email here"
              className="w-full bg-white/5 border border-white/10 rounded-xl px-10 py-3 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
              required
            />
          </div>
